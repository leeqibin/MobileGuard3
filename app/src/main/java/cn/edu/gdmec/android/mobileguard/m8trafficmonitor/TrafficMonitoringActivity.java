...
public class TrafficMonitoringActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!SystemInfoUtils
                .isServiceRunning(this, "cn.edu.gdmec.android.mobileguard.m8trafficmonitor.service.TrafficMonitoringService")) {
    ...
    class CorrectFlowReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Object[] ojbs = (Object[]) intent.getExtras().get("pdus");
            for (Object ojb : ojbs) {
                SmsMessage smsMessage = SmsMessage.createFromPdu((byte[]) ojb);
